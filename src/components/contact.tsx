...
import { PhoneIcon, InboxIcon as EnvelopeIcon, MapPinIcon, CheckCircle, Loader2 } from "lucide-react"
      ...
      <div className="container mx-auto max-w-7xl px-4">
        <motion.div style={{ opacity, scale }} className="text-center mb-16">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Let&apos;s connect! Whether you have a project in mind or just want to say hello, I&apos;d love to hear from
            you.
          </p>
        </motion.div>
              ...
              <CardContent>
                <form ref={formRef} onSubmit={handleSubmit} className="grid gap-4">
                  ...
                  <AnimatePresence mode="sync">
                    <motion.div
                      key={isSubmitting ? "submitting" : isSuccess ? "success" : "idle"}
                      initial={{ opacity: 0 }}
                      animate={{ opacity: 1 }}
                      exit={{ opacity: 0 }}
                    >
