...
import { Home, User, Briefcase, GraduationCap, Rocket, Mail, Moon, Sun, ArrowUp } from "lucide-react"
import LoadingPage from "./loading"
// Add the import for CustomCursor at the top of the file
...
export default function EnhancedPortfolioLayout() {
  ...
  return (
    <div className={cn("min-h-screen bg-background text-foreground overflow-hidden", theme)}>
      ...
      <main ref={mainRef} className="relative min-h-screen w-full overflow-x-hidden">
        ...
        <div className="relative z-40">
          ...
          <section id="education-and-skills" className="min-h-screen snap-start">
      ...
      <footer className="relative z-10 bg-background/80 backdrop-blur-sm py-6 text-center">
        <div className="container mx-auto">
          <p className="text-muted-foreground mb-2">
            &copy; {new Date().getFullYear()} {pageInfo?.name}. All rights reserved.
          </p>
